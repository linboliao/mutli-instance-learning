...
class Whole_Slide_Bag_FP(Dataset):
    def __init__(self,
        ...
        # slide = wsi.read_region((0, 0), level=0, size=wsi.level_dimensions[0])
        slide = get_aslide_image(wsi, (0,0), 0, wsi.level_dimensions[0])
        slide.thumbnail(wsi.level_dimensions[self.patch_level])
        self.wsi = openslide.open_slide(slide)
