...
class PatchGCN(nn.Module):
    def __init__(self, num_layers=4, edge_agg='spatial', multires=False, resample=0,
        fusion=None, num_features=1024, hidden_dim=128, linear_dim=64, use_edges=False, pool=False, dropout=0.25, n_classes=1,dataname='ucec'):
    ...
    def forward(self, data):
        ...
        batch = edge_index.new_zeros((data_x.size(0),1)).flatten()
        edge_attr = None
